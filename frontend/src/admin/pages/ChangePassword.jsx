...
import { changePassword, getEmailSettingsAdmin, updateEmailSettings } from '../api/adminResources'
...
/** Contact-form email behavior (owner notification, visitor auto-reply), embedded as a section within Settings. */
function EmailSettingsSection() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-display text-lg font-bold text-ink">Email Settings</h2>
...
/** Settings page: change the logged-in admin's own password, plus contact-form email behavior. */
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-3 font-display text-2xl font-bold text-ink">Account &amp; Email Settings</h1>
      </div>
