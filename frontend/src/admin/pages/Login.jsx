  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-ink bg-dot-grid px-4">
      <div className="w-full max-w-sm overflow-hidden rounded-2xl border border-cream/10 bg-ink-soft shadow-2xl">
        ...
        <div className="p-7">
          <h1 className="font-display text-xl font-bold text-cream">Admin Login</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              <label className="mb-1.5 block font-mono text-xs text-cream/50">username</label>
              <input
                required
                name="username"
            ...
            <div>
              <label className="mb-1.5 block font-mono text-xs text-cream/50">password</label>
              <input
                required
                type="password"
                name="password"
          ...
          <div className="mt-5 flex items-center justify-between font-mono text-xs">
            <Link to="/admin/forgot-password" className="text-cream/40 hover:text-accent">
              Forgot password?
            </Link>
            <Link to="/" className="text-cream/40 hover:text-accent">
              &larr; Back to site
            </Link>
          </div>
        </div>
