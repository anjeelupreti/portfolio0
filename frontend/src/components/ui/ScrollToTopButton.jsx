    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          whileTap={{ scale: 0.96 }}
          className="fixed bottom-6 left-6 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-ink/10 bg-ink text-cream shadow-lg shadow-black/20"
        >
          <ArrowUp size={20} />
        </motion.button>
      )}
