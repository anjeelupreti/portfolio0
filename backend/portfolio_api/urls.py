...
router.register(r"experience-highlights", views.ExperienceHighlightViewSet, basename="experiencehighlight")
...
router.register(r"pricing-features", views.PricingFeatureViewSet, basename="pricingfeature")
